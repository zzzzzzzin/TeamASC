			...
			<form action="${contextPath}/manager/updateUserInfo" method="POST">
				...
				<div class="userInfo">
					<div class="itemWrap">
						...
						<input type="text" name="userSeq" value="${member.userSeq}" class="form" readonly="readonly">
					</div>	
						<br />
					<div class="itemWrap">
					...
					<div class="itemWrap">
						...
						<input type="text" name="id" id="id" value="${member.pwd}" class="form" readonly="readonly"> 
					</div>			
						<br />
					<div class="itemWrap">
				...
				<div class="plusInfo">
					...
					<div class="itemWrap">
						...
						<input type="text" name="joinDate" class="form" value="${member.joinDate}" readonly="readonly">
					</div>
						<br />
					<div class="itemWrap">
						...
						<c:choose>
							<c:when test="${member.status eq 'Y'}">
								<input type="text" name="status" class="form" value="활동 회원 + ${member.status}" readonly="readonly" />
							</c:when>
							<c:otherwise>
								<input type="text" name="status" class="form" value="비활동 회원 + ${member.status}" readonly="readonly" />
							</c:otherwise>
						</c:choose>
					</div>
						<br />
